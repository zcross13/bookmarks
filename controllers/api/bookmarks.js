...
//think about what functionality you need to do 
...
const destroyBookmark = async (req, res, next) => {
    //req request user make 
    //res response we respond back to the user with 
    //next is the next function we will response to the user with 
    try{
...
const createBookmark = async (req, res, next) => {
    try{
        ...
        user.bookmarks.addToSet(createdBookmark) // call add to set function to take createdbookmark and add it to our bookmarks and saving it to user
        await user.save()
